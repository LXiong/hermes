...
public class GraphiteEndpoint implements EnvironmentAware {
    ...
    private static final String TOPIC_URL_PATTERN = "/.*sumSeries%28stats.tech.hermes\\.(consumer|producer)\\.%2A\\.meter\\.[^\\.]*\\.[^\\.]*\\.m1_rate%29.*";

    private static final String SUBSCRIPTION_URL_PATTERN = "/.*sumSeries%28stats.tech.hermes\\.consumer\\.%2A\\.meter\\.[^\\.]*\\.[^\\.]*\\.[^\\.]*\\.m1_rate%29.*";
